...
```json
{"type":"data","id":"ws-01","fw":"3.0.0-alpha.3","seq":123,"t":21.4,"rh":63.0,"p":1013.2,"rain":0.6,"ws":3.2,"wg":5.1,"wd":270,"soil":42,"vbat":3.98,"soc":87,"ibat":-52,"ipan":120,"iload":35}
```
...
| `soil` | uint | % | Sonda capacitiva | Umidità del terreno, 0 = secco, 100 = saturo |
